# Career Mantra – Personality-Based Career Guidance System

Career Mantra is a web-based platform built using **HTML, CSS, JavaScript**, and **Firebase** that provides personality-based career suggestions along with e-courses, skill tracking, roadmaps, and job/internship application features.
...
4. Copy the Firebase config snippet into `firebase-config.js`.  
5. (Optional) Enable **Firebase Hosting** to deploy the project.
